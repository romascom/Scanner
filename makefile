# add support for proftest.in - check sample file in Milestone 1
...
JFLAGS = -g -d . -cp .:src:src/lexer:src/main:src/symbols:src/inter:src/parser
JC = javac
JVM= java 
FILE=
...
# Generate .jar file
jar:
	jar cf test.jar main/Main.class lexer/*.class symbols/Type.class inter/*.class parser/*.class
